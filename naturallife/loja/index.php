...
if(!isset($_SESSION['logado'])) {
    header("Location: ../login.php?msg=nosession");
}

?>
<html class="js-focus-visible" style="height: auto;">
<head>
  <meta charset="utf-8">
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="carrosel/dist/gallery.min.css">

  <!-- Theme style -->
  <link rel="stylesheet" href="carrosel/dist/gallery.theme.css">
...
<section class="content">
    ...
    <!-- CONTAINER FLUID -- MEIO DA PÁGINA-->
    <div class="container-fluid">
        <!--  APRESENTAÇÃO DOS PRODUTOS -->
        <h4 class="mt-4 mb-2 text-justify text-center text-monospace text-captalise bg-primary">Consulte seus Produtos Aqui</h4>

<div class="container-fluid">
   
    <!-- ROW DO MEIO DA PÁGINA PARA TODOS OS COMPONENTES-->
    <div class="row">
    
        <!-- INFO-BOX RAIZ // ADICIONAR NOVO PRODUTO-->
        <!-- div class="col-sm-4 info-box" >          
            <span style="height:100%; width: 100%;" class="info-box-icon bg-success"><button style="width:100%; height:100%;" class="btn btn-success" type="button" onClick="novo();"><b class="text-justify" style="font-size: 80px;color:white;"><i class="fa fa-plus" aria-hidden="true"></i></b></button></span>
        </div --> <!-- FIM COLUNA 4-->
    
    
        <?php 
            require("loja-controller.php"); 
            $produtos = buscarProdutos();
        ?>
        <?php foreach($produtos as $produto){?>
        
            <!-- Container pro Produto -->    
            <div class="col-lg-6 col-xl-6 col-sm-4 info-box" >
                <div id="carrousel<?php echo $produto['id']; ?>" class="carousel slide container-fluid" data-interval="false">
                    
                <!-- LISTA DOS SLIDES DE CADA PRODUTO-->
                    <!-- ol class="carousel-indicators">
                      <li data-target="#carrousel" data-slide-to="0" class="active mt-4" id="carsousel-1"></li>
                      <li data-target="#carrousel" data-slide-to="1" class=" mt-4" id="carsousel-2"></li>
                      <li data-target="#carrousel" data-slide-to="2" class=" mt-4" id="carsousel-3"></li>
                    </ol -->
                <!-- FIM DA LISTA-->
                ...
                <div class="carousel-inner">
                    ...
                    <!-- SLIDE 1 - APRESENTAÇÃO DO PRODUTO -->   
                    <div class="carousel-item text-center bg-light active">
                            <div class="card card-widget widget-user">
                                
                                <div class="widget-user-header bg-success">
                                    <h3 class="widget-user-username float-left"><?php echo $produto['nome']?></h3>
                                    <h5 class="widget-user-desc float-right"></h5>
                                </div>
                                
                                <div class="widget-user-image">
                                    <img class="img-circle" src="<?php echo $produto['linkimg']; ?>" alt="Product Image">
                                </div>
                                
                                <div class="card-footer bg-light ">
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            <form id="form-prod_<?php echo $produto['id'];?>" onsubmit="envia_form<?php echo $produto['id'];?>();">
                                                <input type="hidden" id="id_<?php echo $produto['id'];?>">
                                                <button type="submit" class="btn btn-sm btn-success">Adicionar <i class="fa fa-cart-plus" aria-hidden="true"></i></button>
                                            </form>
                                        </div>
                                        
                                        <!-- SCRIPT PERSONALIZADO PRA CADA PRODUTO -->
                                        <script type="text/javascript">
                                            
                                            //busca o formulário
                                            var form<?php echo $produto['id'];?> = document.getElementById('form-prod_<?php echo $produto['id'];?>');
                                            
                                            function envia_form<?php echo $produto['id'];?>()
                                            {
                                                
                                                form<?php echo $produto['id'];?>.onsubmit(function(event){
                                        ...
                                        <div class="col-sm-4 text-center">
                                         ...
                                         <div class="col-sm-4 text-center">
                                            <div class="description-block">
                                                ...
                                                <span class="description-text"><?php echo $produto['preco'];?></span>
                                            </div>
                                         </div>
                    ...
                    <!-- slide 2 - FOTOS DE APRESENTAÇÃO -->
                    <div class="carousel-item bg-light">
                        <img class="img-fluid container-fluid" src="<?php echo $produto['linkimg'] ?>">
                    </div>
                        
                </div> <!-- FIM do Carousel inner -->
    
                    
                    <!-- BOTÕES DE CONTROLE = RETROCEDER -->
                    <a class="carousel-control-prev" href="#carrousel<?php echo $produto['id']; ?>" role="button" data-slide="prev">
                        <span class="carousel-control-prev-icon"></span>
                        <span class="sr-only">Anterior</span>
                    </a>
                    
                    <!-- BOTÕES DE CONTROLE = AVANÇAR -->
                    <a class="carousel-control-next" href="#carrousel<?php echo $produto['id']; ?>" role="button" data-slide="next">
                        <span class="carousel-control-next-icon"></span>
                        <span class="sr-only">Próximo</span>
                    </a>
            
            </div> <!-- FIM DO CAROUSEL -->
        </div> <!-- FIM INFO-BOX COL-4 CAROUSEL  -->

        <?php } ?>
        
    </div> <!-- Fim da ROW -->
</div>  <!-- FIM DO GRANDE CONTAINER FLUID-->
</section>
  ...
  <footer class="main-footer">
    <div class="float-left d-none d-sm-block">
      <b>NaturalLife - Shop</b> 
    </div>
    <strong class="float-right">Copyright © 2020-2021 <a href="../index.php">Página Inicial</a> ||</strong> <i>"Viver, pensar e agir sustentáveis"</i>
  </footer>
