...
<head>
  ...
  <title>Artigos | NaturalLife</title>
...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <h4 class="mt-4 mb-2 text-justify text-center text-monospace text-captalise bg-primary">Artigos</h4>
            ...
            <div class="card card-widget collapsed-card">
              <div class="card-header">
                <div class="user-block">
                  <img class="img-circle" src="/imagens/<?php echo $artigo['foto'];?>" alt="Autor">
                  <span class="username"><a href="#"></a></span>
                  <span class="description"><h4><?php echo $artigo['titulo']; ?></h4></span>
                </div>
                <!-- /.user-block -->
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" title="Marcar como Lido">
              ...
              <div class="card-body" style="display: none;">
                ...
                <p class="text-justify"><?php echo $artigo['texto'];?></p>
                <!-- button type="button" class="btn btn-default btn-sm"><i class="fas fa-share"></i> Share</button -->
                <button type="button" class="btn btn-default btn-sm"><i class="fa fa-heart text-danger" aria-hidden="true"></i> Like</button>
                <span class="float-right text-muted">Número de Likes - 3 Comentários</span>
              </div>
              <!-- /.card-body -->
